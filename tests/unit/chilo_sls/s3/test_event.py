...
from chilo_sls.s3.event import Event
from chilo_sls.s3.record import Record
from chilo_sls.common.records.exception import RecordException

from tests.unit.mocks.s3 import mock_event
from tests.unit.mocks.s3.mock_data_class import MockS3DataClass
...
class S3EventTest(unittest.TestCase):
    ...
    mock_aws = mock_aws()
    schema_path = 'tests/unit/mocks/s3/openapi.yml'
