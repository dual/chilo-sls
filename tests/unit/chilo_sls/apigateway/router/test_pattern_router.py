...
from tests.unit.mocks.apigateway import mock_middleware, mock_request


class RouterPatternTest(unittest.TestCase):
    maxDiff = None
    base_path = 'unit-test/v1'
    handler_pattern = 'tests/unit/mocks/apigateway/router/pattern_handlers/**/*_controller.py'
    schema_path = 'tests/unit/mocks/apigateway/openapi.yml'
    base_path_schema_path = 'tests/unit/mocks/apigateway/base_path_openapi.yml'
