...
from chilo_sls.documentdb.event import Event
from chilo_sls.documentdb.record import Record
from chilo_sls.common.records.exception import RecordException

from tests.unit.mocks.documentdb import mock_event
from tests.unit.mocks.documentdb.mock_data_class import MockDocumentDBDataClass


class DocumentDBEventTest(unittest.TestCase):
    basic_event = mock_event.get_basic()
    schema_path = 'tests/unit/mocks/documentdb/openapi.yml'
    expected_body = {
