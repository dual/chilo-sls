...
from chilo_sls.dynamodb.event import Event
from chilo_sls.dynamodb.record import Record
from chilo_sls.common.records.exception import RecordException

from tests.unit.mocks.dynamodb import mock_event
from tests.unit.mocks.dynamodb.mock_data_class import MockDDBDataClass
...
class DynamoDBEventTest(unittest.TestCase):
    ...
    schema_path = 'tests/unit/mocks/dynamodb/openapi.yml'
    expected_body = {
