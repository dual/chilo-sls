...
from chilo_sls.common.records.event import Event
from chilo_sls.common.records.record import Record

from tests.unit.mocks.common.mock_data_class import MockDataClass
