...
from chilo_sls.common.schema import Schema
from tests.unit.mocks.common.mock_pydantic_class import Request


class SchemaTest(unittest.TestCase):
    maxDiff = None
    schema_path = 'tests/unit/mocks/common/openapi.yml'
    schema_dict = {
        'type': 'object',
        'required': ['id', 'body'],
