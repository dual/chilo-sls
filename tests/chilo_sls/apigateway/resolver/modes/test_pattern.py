...
class PatternModeResolverTest(unittest.TestCase):
    ...
    handler_directory = 'tests/mocks/apigateway/resolver/directory_handlers'
    handler_directory_no_root_init = 'tests/mocks/apigateway/resolver/directory_handlers_no_root_init'
    ...
    def test_directory_like_basic_get_file_and_import_path(self):
        ...
        self.assertIn('tests/mocks/apigateway/resolver/directory_handlers/basic.py', file_path)
    ...
    def test_directory_like_nested_get_file_and_import_path(self):
        ...
        request = Request(self.nested_request)
        file_path, import_path = resolver._get_file_and_import_path(request.path)
        self.assertIn('tests/mocks/apigateway/resolver/directory_handlers/nested_1/nested_2/basic.py', file_path)
    ...
    def test_directory_like_default_init_get_file_and_import_path(self):
        ...
        request = Request(self.init_request)
        file_path, import_path = resolver._get_file_and_import_path(request.path)
        self.assertIn('tests/mocks/apigateway/resolver/directory_handlers/home/__init__.py', file_path)
    ...
    def test_directory_like_base_path_get_file_and_import_path(self):
        ...
        file_path, import_path = resolver._get_file_and_import_path(request.path)
        self.assertIn('tests/mocks/apigateway/resolver/directory_handlers/__init__.py', file_path)
    ...
    def test_directory_like_dynamic_get_file_and_import_path(self):
        ...
        request = Request(self.dynamic_request)
        file_path, import_path = resolver._get_file_and_import_path(request.path)
        self.assertIn('tests/mocks/apigateway/resolver/directory_handlers/dynamic/_id_.py', file_path)
    ...
    def test_directory_like_triple_dynamic_get_file_and_import_path(self):
        ...
        request = Request(self.triple_request)
        file_path, import_path = resolver._get_file_and_import_path(request.path)
        self.assertIn('tests/mocks/apigateway/resolver/directory_handlers/triple/_coordinates.py', file_path)
    ...
    def test_directory_like_single_nested_dynamic_get_file_and_import_path(self):
        ...
        request = Request(dynamic_nested_request)
        file_path, import_path = resolver._get_file_and_import_path(request.path)
        self.assertIn('tests/mocks/apigateway/resolver/directory_handlers/user/_user_id/__init__.py', file_path)
    ...
    def test_directory_like_double_nested_dynamic_get_file_and_import_path(self):
        ...
        request = Request(dynamic_nested_request)
        file_path, import_path = resolver._get_file_and_import_path(request.path)
        self.assertIn('tests/mocks/apigateway/resolver/directory_handlers/user/_user_id/item/__init__.py', file_path)
    ...
    def test_directory_like_triple_nested_dynamic_get_file_and_import_path(self):
        ...
        request = Request(dynamic_nested_request)
        file_path, import_path = resolver._get_file_and_import_path(request.path)
        self.assertIn('tests/mocks/apigateway/resolver/directory_handlers/user/_user_id/item/_item_id.py', file_path)
